...
if Lugar == "Concha Acústica da UFPE" :
    ...
    frase = "Aqui é muito grande mesmo! Muitos eventos ocorrem por aqui!"
    ...
    frase = "Nossa, mas esse lago é longe hein?!"
    ...
    frase = "Um dos hospitais mais importantes do estado também fica na área do Campus da UFPE!"
    ...
    frase = "Que legal! O Ginásio é bem perto do CIn!"
